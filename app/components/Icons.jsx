 ...
 * Colección de íconos profesionales para el dashboard
 * Fuente: Material Symbols / Material Icons
 */
...
// Ícono Door / Salida
export const DoorIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
// Ícono History / Historial
export const HistoryIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 8V12L15 15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M3.05 11C3.51 6.93 6.93 3.51 11 3.05M21 12C21 16.97 16.97 21 12 21C9.39 21 7.09 19.78 5.57 17.89M3 21V17M3 17H7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

// Ícono Alert / Pendiente
